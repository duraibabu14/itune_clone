...
class _ApiService implements ApiService {
  ...
  Future<HttpResponse<SearchResultResponseEntity>> searchItuneStore(
    ...
    final _options =
        _setStreamType<HttpResponse<SearchResultResponseEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late SearchResultResponseEntity _value;
    try {
      _value = SearchResultResponseEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
